    ...
    \begin{columns}[T]
        \begin{column}{0.95\textwidth} % 使用大寬度確保內容居中
            ...
            \begin{itemize}
                ...
                \item Enables the agent to capture a user's unique heart rate signature over time.
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Summary}
    \begin{itemize}
        \item \textbf{Innovation}: Our system capture individual norms to bridge the monitoring gap.
